...
export default function Pomodoro({ profile, config, accountId, onProfile, onView, onOpenDetached, isVisible = true }: Props) {
  ...
  function openNextSessionPicker() { if (running || mode !== "focus" || pendingTransition !== "focus") return; setSessionSummary(null); setSubjectConfirmationOpen(true); }
