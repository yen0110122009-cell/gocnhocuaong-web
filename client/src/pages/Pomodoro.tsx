...
export default function Pomodoro({ profile, config, onProfile, onView, isVisible = true }: Props) {
  ...
  return <div className="space-y-6">
    ...
    {hasPersistedSession ? <button type="button" className="fixed bottom-20 right-3 z-40 rounded-full border border-[#c62828]/25 bg-white/95 px-4 py-2 text-xs font-black text-[#c62828] shadow-lg backdrop-blur dark:bg-slate-950/95 dark:text-red-300" onClick={restorePersistedSession}>↻ Khôi phục phiên Pomodoro</button> : null}
