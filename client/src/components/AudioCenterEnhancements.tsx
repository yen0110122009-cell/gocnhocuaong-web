...
export function AudioCenterEnhancements({ profile, onProfile, voiceLines, playbackStatus, onPlayAsset, onStopPlayback, onSeekPlayback }: Props) {
  ...
  const [previewRate, setPreviewRate] = useState<0.5 | 1 | 1.5 | 2>(1);
