...
export function StudyProgressOverview({ profile, goals, todaySeconds, weekSeconds }: Props) {
  ...
  const palette = ["var(--scene-accent)", "var(--scene-accent-alt)", "color-mix(in srgb, var(--scene-accent) 65%, var(--scene-accent-alt))", "color-mix(in srgb, var(--scene-accent) 35%, var(--scene-card))", "color-mix(in srgb, var(--scene-accent-alt) 55%, var(--scene-card))", "var(--scene-border)"];
