...
import { antiProcrastinationChoices, randomAntiProcrastinationSpeech, speechForEvent, speechGroupLabels, type SpeechGroup } from "../lib/speechLibrary";
...
export function ExperienceStudio({ selected, onSelect, onStartTwoMinutes }: Props) {
  ...
  function chooseAntiProcrastination(id: "five" | "review" | "lumi") {
    ...
    if (id === "lumi") setSpeech(randomAntiProcrastinationSpeech());
