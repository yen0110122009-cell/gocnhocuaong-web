...
export const emotionThemes: EmotionTheme[] = [
  ...
  { id: "happy", label: "Vui vẻ", emoji: "🌞", description: "Năng lượng ấm áp để bắt đầu.", encouragement: "Lumi vui cùng Ong. Niềm vui hôm nay cũng là một phần của hành trình học tập.", mascot: "lumi", colors: { primary: "#d32f2f", secondary: "#388e3c", soft: "#fff8e1", ink: "#6d1b1b", glow: "#ffe082" } },
  { id: "tired", label: "Mệt", emoji: "🥱", description: "Giảm áp lực, giữ nhịp vừa đủ.", encouragement: "Lumi hiểu là Ong đang mệt. Mình thử hai phút thôi, rồi quyết định tiếp nhé.", mascot: "lumi", colors: { primary: "#b71c1c", secondary: "#558b2f", soft: "#f7f1ec", ink: "#4e2020", glow: "#e6d5c9" } },
  ...
  { id: "stressed", label: "Căng thẳng", emoji: "🌬️", description: "Thở chậm, chia nhỏ việc.", encouragement: "Lumi cùng Ong tạm dừng một nhịp. Việc lớn sẽ dễ hơn khi chia thành bước nhỏ.", mascot: "lumi", colors: { primary: "#b3261e", secondary: "#237a57", soft: "#fff5f2", ink: "#53201e", glow: "#ffcdd2" } },
  { id: "lazy", label: "Lười", emoji: "🫠", description: "Chế độ thử 2 phút, không ép buộc.", encouragement: "Lumi không ép Ong đâu. Mình chỉ mở sách trong 2 phút thôi nhé.", mascot: "lumi", colors: { primary: "#c62828", secondary: "#6a994e", soft: "#fff9ed", ink: "#55321f", glow: "#f6d7a7" } },
  { id: "proud", label: "Tự hào", emoji: "🌟", description: "Ghi nhận từng bước đã đi.", encouragement: "Lumi nhìn thấy rồi: Ong đã làm được. Hãy ghi nhận một bước nhỏ mà mình vừa thắng.", mascot: "lumi", colors: { primary: "#c62828", secondary: "#2e7d32", soft: "#fff3e0", ink: "#652019", glow: "#ffcc80" } },
