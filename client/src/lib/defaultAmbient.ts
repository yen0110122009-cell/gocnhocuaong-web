...
export const PROVIDED_THEME_AMBIENT_ASSETS = {
  ...
  fairytale_castle: { id: "provided-theme-fairytale-castle", name: "Lâu Đài Cổ Tích · Music Box", description: "Track Trung Thu local; link YouTube chỉ là tham chiếu.", url: LOCAL_FESTIVE_AUDIO["tet-trung-thu"], target: "fairytale_castle", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=mVnImSxvAV8" },
  circus_fun: { id: "provided-theme-circus-fun", name: "Gánh Xiếc · Carnival", description: "Track lễ hội local; link YouTube chỉ là tham chiếu.", url: LOCAL_FESTIVE_AUDIO["quoc-khanh-2-9"], target: "circus_fun", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=79yzXoj0EOo" },
  prehistoric_era: { id: "provided-theme-prehistoric-era", name: "Thời Tiền Sử · Primeval Forest", description: "Track rừng nguyên sinh local; link YouTube chỉ là tham chiếu.", url: LOCAL_FESTIVE_AUDIO["gio-to-hung-vuong"], target: "prehistoric_era", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=Jx5CR-RYJnI" },
  cyberpunk_racetrack: { id: "provided-theme-cyberpunk-racetrack", name: "Đường Đua Cyberpunk · Synthwave", description: "Track nhịp điện tử local; link YouTube chỉ là tham chiếu.", url: LOCAL_FESTIVE_AUDIO["ngay-thanh-nien-26-3"], target: "cyberpunk_racetrack", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=mVnImSxvAV8" },
  food_festival: { id: "provided-theme-food-festival", name: "Lễ Hội Ẩm Thực · Street Food", description: "Track mùa hè lễ hội local; link YouTube chỉ là tham chiếu.", url: LOCAL_FESTIVE_AUDIO["tet-doan-ngo-5-5"], target: "food_festival", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=yJg-Y5byMMw" },
  spring_freshness: { id: "provided-theme-spring-freshness", name: "Mùa Xuân Thanh Tân · Chim và chuông gió", description: "Audio buổi sáng local; link YouTube chỉ là tham chiếu.", url: LOCAL_AMBIENT_AUDIO.morning, target: "spring_freshness", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=eCyoahdsPGY" },
  summer_ocean: { id: "provided-theme-summer-ocean-exact", name: "Mùa Hạ Biển Xanh · Sóng và hải âu", description: "Audio biển local; link YouTube chỉ là tham chiếu.", url: LOCAL_AMBIENT_AUDIO.rain, target: "summer_ocean", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=eCyoahdsPGY" },
  autumn_leaves: { id: "provided-theme-autumn-leaves", name: "Mùa Thu Lá Vàng Rơi · Gió và lá", description: "Audio gió/lá local; link YouTube chỉ là tham chiếu.", url: LOCAL_AMBIENT_AUDIO.rain, target: "autumn_leaves", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=8V90Cu5UUIM" },
  winter_snowman: { id: "provided-theme-winter-snowman", name: "Mùa Đông Người Tuyết · Lò sưởi", description: "Audio mưa/gió local; link YouTube chỉ là tham chiếu.", url: LOCAL_AMBIENT_AUDIO.rain, target: "winter_snowman", source: "provided", referenceUrl: "https://www.youtube.com/watch?v=YexNu5MAKWw" },
