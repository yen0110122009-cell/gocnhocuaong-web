...
describe("Easter Egg 🍀 contract", () => {
  ...
  it("renders a fixed bottom-right trigger with the requested visual states", () => {
    expect(component).toContain("fixed bottom-5 right-5 z-[999]");
  ...
  it("mounts the Easter Egg globally and provides the Account setting", () => {
    ...
    expect(home).toContain("<EasterEgg />");
