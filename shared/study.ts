...
export function normalizeProfile(value: unknown): ProfileState {
  ...
  const merged: ProfileState = {
    ...
    defaultAmbientScene: ["morning", "rain", "snow", "leaves", "storm", "summer", "spring", "tet", "halloween", "desert", "night", "naturepark", "sunrise", "mountainsunset", "meteorice", "galaxy", "cityday", "citysunset", "citydusk", "citynight", "bridgefog", "urbanfog", "sparklers", "fireworks", "forest", "sunset", "space", "crescentmoon", "ocean", "neon", "sakura", "autumn", "festival"].includes(String(source.defaultAmbientScene)) ? source.defaultAmbientScene as AmbientScenePreference : base.defaultAmbientScene,
