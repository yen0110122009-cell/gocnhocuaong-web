...
export type DailyPhoneRewardSettings = {
  baseMinutes: number;
  bonusMinutesPerStudyBlock: number;
};
...
export type PomodoroSession = {
  ...
  endedAt: string;
  durationMinutes: number;
  /** Số giây thực tế đã học; dùng cho phiên dừng sớm và giữ độ chính xác dưới một phút. */
  elapsedSeconds?: number;
  subject: string;
  topic: string;
