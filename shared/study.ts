...
export type AmbientScenePreference = "morning" | "rain" | "snow" | "leaves" | "storm" | "summer" | "spring" | "tet" | "halloween" | "desert" | "night" | "naturepark" | "sunrise" | "mountainsunset" | "meteorice" | "galaxy" | "cityday" | "citysunset" | "citydusk" | "citynight" | "bridgefog" | "urbanfog" | "sparklers" | "fireworks" | "forest" | "sunset" | "space" | "crescentmoon" | "ocean" | "neon" | "sakura" | "autumn" | "festival" | "volcano" | "deepocean" | "magicforest" | "spacestation" | "flowerfield" | "fairytale" | "circus" | "prehistoric" | "cyberrace" | "foodfestival" | "diamondmine" | "f1race" | "candykingdom" | "travel" | "tropical" | "rainy_season" | "stormy_season" | "morning_chill" | "pixel" | "pirate" | "sports" | "disco" | "laboratory" | "egypt" | "steampunk" | "art" | "ninja" | "coffee" | "ai" | "teddy";
  ...
  const merged: ProfileState = {
    ...
    sceneAutomation: {
      ...
      timeRules: Array.isArray(source.sceneAutomation?.timeRules) ? source.sceneAutomation.timeRules.flatMap((rule, index) => {
        ...
        if (!candidate.id || !["morning", "rain", "snow", "leaves", "storm", "summer", "spring", "tet", "halloween", "desert", "night", "naturepark", "sunrise", "mountainsunset", "meteorice", "galaxy", "cityday", "citysunset", "citydusk", "citynight", "bridgefog", "urbanfog", "sparklers", "fireworks", "forest", "sunset", "space", "crescentmoon", "ocean", "neon", "sakura", "autumn", "festival", "volcano", "deepocean", "magicforest", "spacestation", "flowerfield", "fairytale", "circus", "prehistoric", "cyberrace", "foodfestival", "diamondmine", "f1race", "candykingdom", "travel", "tropical"].includes(String(candidate.scene))) return [];
    ...
    audioMixer: {
      ambientSceneVolumes: Object.fromEntries((["morning", "rain", "snow", "leaves", "storm", "summer", "spring", "tet", "halloween", "desert", "night", "naturepark", "sunrise", "mountainsunset", "meteorice", "galaxy", "cityday", "citysunset", "citydusk", "citynight", "bridgefog", "urbanfog", "sparklers", "fireworks", "forest", "sunset", "space", "crescentmoon", "ocean", "neon", "sakura", "autumn", "festival", "volcano", "deepocean", "magicforest", "spacestation", "flowerfield", "fairytale", "circus", "prehistoric", "cyberrace", "foodfestival", "diamondmine", "f1race", "candykingdom", "travel", "tropical"] as AmbientScenePreference[]).map((scene) => [scene, Math.max(0, Math.min(100, Number(source.audioMixer?.ambientSceneVolumes?.[scene] ?? base.audioMixer!.ambientSceneVolumes[scene]) || 0))])) as AudioMixerSettings["ambientSceneVolumes"],
